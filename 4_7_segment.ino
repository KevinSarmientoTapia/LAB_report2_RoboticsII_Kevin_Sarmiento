...
//4 7segment pins:
int clearPin = A1; //Arduino pin A1 connected to Pin 10, SRCLR(Clear/Reset) of 74HC595
int serialData = 3;  //Arduino pin 3 connected to Pin 14, SER(serial input) of 74HC595
int shiftClock = 4;  //Arduino pin 4 connected to Pin 11, SRCLK(shift clock) of 74HC595
int latchClock = 2;  //Arduino pin 2 connected to Pin 12, RCLK(storage/latch clock) of 74HC595
int D1=A4; //Digit 1 to pin A4
